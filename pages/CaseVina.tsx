                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <ScrollReveal>
                        ...
                        <p className="text-xl text-gray-200 font-light max-w-3xl mx-auto leading-relaxed">
                            Diseño e implementación de un sistema de bioconversión con Mosca Soldado Negra para el tratamiento de descartes frutícolas y residuos orgánicos del proceso de packing.
                        </p>
                    </ScrollReveal>
                </div>
            </header>
                    ...
                    <div className="lg:col-span-7 space-y-12">
                        ...
                        <ScrollReveal className="flex flex-col md:flex-row gap-6 items-start">
                            <div className="w-full md:w-1/2 rounded-sm overflow-hidden shadow-lg h-64">
                                <img src="/Fotos/Testimonio/primero del segundo.png" alt="Residuos Frutícolas" className="w-full h-full object-cover" loading="lazy" decoding="async" />
                            </div>
                        ...
                        <ScrollReveal className="flex flex-col md:flex-row gap-6 items-start">
                            <div className="w-full md:w-1/2 order-1 md:order-2 rounded-sm overflow-hidden shadow-lg h-64">
                                <img src="/Fotos/Testimonio/segundo del segundo.png" alt="Larvas BSF" className="w-full h-full object-cover filter contrast-110" loading="lazy" decoding="async" />
                            </div>
                        ...
                        <ScrollReveal className="flex flex-col md:flex-row gap-6 items-start">
                            <div className="w-full md:w-1/2 rounded-sm overflow-hidden shadow-lg h-64">
                                <img src="/Fotos/Testimonio/tercero del segundo.png" alt="Producto Final" className="w-full h-full object-cover" loading="lazy" decoding="async" />
                            </div>
                            <div className="w-full md:w-1/2">
